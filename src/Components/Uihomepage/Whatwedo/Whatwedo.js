...
<h5 className='col-lg-5 text2 textt'>At engineeHUB , we connect all the IITs NITs & State Colleges ,
   so that students  get a competitive environment , get to
...
<h5 className='col-lg-5 text2 textt'>Provide basic guidelines & mentorship
                   to newcomers into engineering field for how
...
<h5 className='col-lg-5 text2 textt'>We provide internship & job updates on regular basis
...
<h5 className='col-lg-5 text2 textt'>We provide live courses on various topic,
 where you can attend live classes , discuss your doubt with 
...
<h5 className='col-lg-5 text2 textt'>We publish various Magzines & Handbooks on 
regular basis , which  are suitable and beneficial  for students . 
</h5>
       </div>
       <div className="col-lg-3 phone-image">
<img src={Phoneimg} alt="" />
