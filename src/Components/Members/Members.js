    ...
    <>
      <div className="container  mw-100 Memberscontainer">
        ...
        <p className="memberstext">
          Lorem ipsum dolor sit amet, consectetur adipiscing elit. At ornare
        ...
        {/* <div className="cardz cardMember">
          <div className="row">
            ...
            <div className="col-lg-9 textofMember">
              ...
              expedita optio aliquam, maxime assumenda quidem perferendis, odio
              deleniti doloribus eaque ipsam modi, impedit velit quis magni
              commodi quas fugiat molestias?
            </div>
          </div>
