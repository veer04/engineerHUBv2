  ...
  return (
    ...
    >
      <div className="card-body custom-card-body-2">
        <img src={cybersecurityimg} style={{ margin: "0px 0px 10px 0px",width:"100%", background:"cover"}} className="card-img-top" alt="..." />
        ...
        <div className="btn-container d-flex justify-content-between align-items-baseline">
          ...
          <p className="btn custom-card-btn-2" style={{ backgroundColor: "#FFC700" ,borderRadius: "20px"}}>
            <span style={{ color: "white", fontSize:"12px" , }}><VisibilityOutlinedIcon/>  1,000 </span>
          </p>
        </div>
      </div>
    </div>
