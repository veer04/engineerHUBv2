...
//             </div>
//             <p className='d-flex txt'>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Molestie eget mattis gravida aliquam eget facilisis nibh.</p>
//             <div class="d-flex justify-content-center mb-2">
//               <button type="button" class="btn btn-primary fs-4">Connect</button>
//             </div>
//         </div>
//         </div>
//         </div>
