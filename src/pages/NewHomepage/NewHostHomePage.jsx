        ...
        <div className="boxCommunity row" style={{background:"#e9fcfc"}}>
            <div className="col-md-6">
                <div className="container">
                    <div className="textContainer">
                        ...
                        Host events, jobs,webinars and
                        </p>
                        <p className='textContent'>
                        Projects to engage audience
                        </p>
                        <p className='textDesc'>
                       Host events to engage your target audience   </p>
                            <p  className='textDesc'>
                            and create Jobs for the right talent.</p> 
                            <div className='wrapButton'>
                        <div onClick={()=>navigate("/host")} style={{
                            width:"220px",
                            borderRadius:"50px",
            ...
            <div className="col-md-6" style={{display:"flex",alignItems:"center"}}>
                ...
                <div className="container" style={{}}>
                    <div className="alignMid image-container" style={{display:"flex",justifyContent:"center"}} >
                              <img src={logoMainPage} alt="" />
                             
                    </div>


                    <div className="row"><img src={Ellipse} alt="" /></div>
                </div>
            </div>
