...
export default function HostingTechnicalEvent() {
  ...
  changeDocumentTitle("Host a Technical Event | engineerHUB");
  ...
  return (
    <main className="hosting-container">
      <aside
        style={{
          backgroundImage: `url(${bucket}technical-event-poster-large.png)`,
        }}
      ...
      <section className="main">
        <div className="header">
          ...
          <div
            style={{
              backgroundImage: `url(${bucket}technical-event-poster-small.png)`,
            }}
