...
export default function HostingHackathon() {
  ...
  changeDocumentTitle("Host a Hackathon | engineerHUB");
  ...
  return (
    <main className="hosting-container">
      <aside
        style={{
          backgroundImage: `url(${bucket}hackathon-poster-large.png)`,
        }}
      ...
      <section className="main">
        <div className="header">
          ...
          <div
            style={{
              backgroundImage: `url(${bucket}hackathon-poster-small.png)`,
            }}
