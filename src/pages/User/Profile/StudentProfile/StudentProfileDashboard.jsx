...
const StudentProfileDashboard = () => {
  ...
  return (
    <div className='container'>
        ...
        <div className='HeaderTxtLorem'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Recusandae placeat alias harum. Saepe voluptatum consequuntur nisi atque adipisci eum, doloribus recusandae
         obcaecati impedit laboriosam asperiores similique quis temporibus quibusdam eligendi.</div>
       <div style={{
        margin:"4%",
        padding:"2%",
       }}>
    ...
    <div className="profile-picture">
          ...
          <div className="progress-counter">{`${progress}%`}</div>
                ...
                <div className="col-lg-6">
                    ...
                    <div className="row">
                        The Indian Institute of Technology Bombay (IIT Bombay) Powai, Mumbai,Maharastra,India.
                    </div>
